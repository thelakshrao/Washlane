        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="relative mt-8 lg:mt-0">
              ...
              <div className="absolute -left-3 bottom-6 bg-white/90 backdrop-blur-md p-2 rounded-xl shadow-lg border border-white flex items-center gap-2 text-xs">
                <div className="bg-[#5F9598] p-1.5 rounded-lg text-white">
