        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center mb-20 md:mb-32">
          ...
          <div className="order-2 lg:order-1">
            ...
            <p className="text-sm md:text-lg text-slate-600 mb-8 md:mb-10 leading-relaxed max-w-lg font-medium">
              WashLane was founded to transform the chore of laundry into a seamless,
              luxurious experience. We combine cutting-edge technology with
              meticulous human care to deliver unparalleled garment treatment.
            </p>
          ...
          <div className="relative order-1 lg:order-2 flex justify-center">
            ...
            <div className="relative z-10 rounded-[2rem] md:rounded-[3rem] overflow-hidden border-[8px] md:border-[12px] border-[#F3F4F4] shadow-2xl rotate-1 hover:rotate-0 transition-all duration-700 w-[80%] md:w-[70%] lg:w-[60%]">
              <img
                src={aboutImage}
